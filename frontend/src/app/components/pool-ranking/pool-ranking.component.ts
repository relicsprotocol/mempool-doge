...
export class PoolRankingComponent implements OnInit {
  ...
  ngOnInit(): void {
    if (this.widget) {
      ...
      this.seoService.setDescription($localize`:@@meta.description.dogecoin.graphs.pool-ranking:See the top Dogecoin mining pools ranked by number of blocks mined, over your desired timeframe.`);
