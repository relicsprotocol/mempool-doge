...
export class BlockRewardsGraphComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.seoService.setDescription($localize`:@@meta.description.dogecoin.graphs.block-rewards:See Dogecoin block rewards in DOGE and USD visualized over time. Block rewards are the total funds miners earn from the block subsidy and fees.`);
