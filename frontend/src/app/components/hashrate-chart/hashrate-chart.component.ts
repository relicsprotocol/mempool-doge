...
export class HashrateChartComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if (this.widget) {
      ...
      this.seoService.setDescription($localize`:@@meta.description.dogecoin.graphs.hashrate:See hashrate and difficulty for the Bitcoin${seoDescriptionNetwork(this.network)} network visualized over time.`);
