...
export class BlockFeesGraphComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.seoService.setDescription($localize`:@@meta.description.dogecoin.graphs.block-fees:See the average mining fees earned per Dogecoin block visualized in DOGE and USD over time.`);
